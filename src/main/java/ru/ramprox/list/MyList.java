...
public class MyList<T> implements List<T>, AuthorHolder {
    ...
    public MyList(int initCapacity, int maxCapacity) {
    ...
    public List<T> subList(int fromIndex, int toIndex) {
        ...
        List<T> subList = new MyList<>(length);
    ...
    public void sort(Comparator<? super T> comparator) {
        ...
        ForkJoinPoolSorting<T> sorting = new ForkJoinPoolSorting<>(this.items, size, comparator);
        sorting.sort();
    }
    ...
    private class MyListIterator implements ListIterator<T> {
        ...
        public void remove() {
            ...
            MyList.this.remove(lastReturnedItemIndex);
        ...
        public void add(T item) {
            MyList.this.add(currentIndex, item);
            currentIndex++;
            lastReturnedItemIndex = -1;
        }
    }
